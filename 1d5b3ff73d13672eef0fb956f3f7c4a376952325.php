      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block" style="margin-top:70px">
              <img width="500x" src="../admin_asset/images/home/logo1.png" alt="">
              </div>
              <div class="col-lg-6">
                <div class="p-5">
...
<?php echo $__env->make('admin.widget.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\WebShoes\WebBanGiay\resources\views/admin/login.blade.php ENDPATH**/ ?>