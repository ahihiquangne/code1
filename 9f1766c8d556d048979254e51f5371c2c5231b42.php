...
<body id="page-top">
  <div id="wrapper" >
    <ul style="background-color:#292828!important" class="navbar-nav  sidebar sidebar-dark accordion" id="accordionSidebar">

      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="admin">
        <div class="sidebar-brand-text mx-3">XShop<sup></sup></div>
      </a>
  ...
  <?php echo $__env->make('admin.widget.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
  <?php /**PATH E:\xampp\htdocs\WebShoes\WebBanGiay\resources\views/admin/widget/index.blade.php ENDPATH**/ ?>