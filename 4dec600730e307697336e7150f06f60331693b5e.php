        ...
        <div class="splash-container">
            <div class="panel panel-default panel-border-color panel-border-color-primary">
                ...
                <div class="panel-body">
                    ...
                    <?php endif; ?>
                    <form action="<?php echo e(route('brands.store')); ?>" method="POST" role="form" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
<?php /**PATH E:\xampp\htdocs\xshop\resources\views/admin/brand/create.blade.php ENDPATH**/ ?>